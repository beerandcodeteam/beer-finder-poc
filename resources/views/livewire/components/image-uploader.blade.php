<div>
    <flux:field>
        ...
        <!-- Preview das imagens pendentes (ainda não salvas) -->
        @if (!empty($images))
            <div class="mb-4">
        ...
        @if (empty($existingImages) && empty($images))
            <div class="py-8 text-center border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg">
                <flux:text class="text-gray-500 dark:text-gray-400">
                    Nenhuma imagem adicionada ainda. Selecione arquivos acima para fazer upload.
                </flux:text>
            </div>
        @endif
    </flux:field>

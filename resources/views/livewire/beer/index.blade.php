    ...
    <flux:main container="">
        ...
        <div class="flex flex-row items-center w-full justify-between">
            ...
            <flux:button
                ...
                icon="plus-circle">Criar nova cerveja</flux:button>
        </div>
        ...
        <div class="grid lg:grid-cols-13 gap-4 mb-6 items-end">
            ...
            <flux:field class="col-span-3">
                <flux:select label="Regra" :disabled="empty($filters['prop_filter'])" wire:model.live="filters.prop_filter_rule">
                    ...
                    <flux:select.option value="<">Menor</flux:select.option>
        ...
        <x-section>
            <x-table>
                <x-table.columns>
                    ...
                    <x-table.column
                        wire:click="sort('first_brewed_date')"
                        sortable
                        :sorted="$sortBy === 'first_brewed_date'"
                ...
                <x-table.rows>
                    @foreach($beers as $beer)
                        <x-table.row wire:key="$beer['id']">
                            <x-table.cell>{{ $beer['name'] }}</x-table.cell>
                            <x-table.cell>{{ $beer['first_brewed_date']->format('d/m/Y') }}</x-table.cell>

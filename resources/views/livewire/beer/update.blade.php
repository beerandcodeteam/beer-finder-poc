<div>
    <flux:main container="">
        <div class="flex flex-row items-center w-full justify-between mb-6">
            <div>
                <flux:heading size="xl">Criar Cerveja</flux:heading>
                <flux:text class="mt-2 text-base">Cadastre uma nova cerveja</flux:text>
            </div>

            <flux:button variant="ghost" icon="arrow-left" :href="route('beers.index')" wire:navigate>
                Voltar
            </flux:button>
        </div>
                ...
                <div class="grid lg:grid-cols-4 gap-6">
                    <flux:field>
                        <flux:input
                            ...
                            type="date"
                            wire:model="form.first_brewed_date"
                            required
                        />
                    </flux:field>

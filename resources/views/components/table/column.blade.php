@props(['sortable' => null, 'direction' => null, 'sorted' => false])
<th class="py-3 px-3 first:ps-0 last:pe-0 text-start text-sm font-medium text-zinc-800 dark:text-white border-b border-zinc-800/10 dark:border-white/20"
